...
//
//   - legacy-00001-00052 is the chain that built every database that exists
//     today, up to and including the Phase A ledger. It stays the default, so
//     the same tree keeps serving, testing, and migrating on the current
//     schema while the squash is being rehearsed.
//   - migrations holds the single 00001_baseline.sql: the post-00052 schema
...
const (
	// ProfileLegacyChain is 00001-00052: the schema every live database is
	// on today. Default.
