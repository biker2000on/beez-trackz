/**
 * Satellite tile math (Esri World Imagery, slippy-map tiling scheme).
 *
 * The canvas has a real-world scale (PX_PER_METER), so tiles are
 ...
 * positioned in canvas world coordinates so the apiary lat/lng sits at
 * `anchor`.
 */
